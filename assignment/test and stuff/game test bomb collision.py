    ...
    if playing:
        ...
        for hlaser in hlasers:
            ...
            if hlaser_life < 1: # column is harmless for 1 second
                ...
                pygame.draw.rect(rot_surface, hlaser_color, pygame.Rect(hlaser[0], hlaser[1], hlaser_width, hlaser_height))
        ...
        if play_time - bomb_spawn_seconds > 2500:
            ...
            bomb_num = 0
        for bomb in bombs:
            #circle = pygame.gfxdraw.filled_circle(rot_surface, bomb[0] + 128, bomb[1] + 128, 128, (255, 255, 255))
